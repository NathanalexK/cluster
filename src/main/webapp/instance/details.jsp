...
<form action="${pageContext.request.contextPath}/instance/update" method="post">
    ...
    <table>
        ...
        <td>Port</td>
        <td><input type="text" name="port" value="<%=instance.getPort()%>"/>        <small>(Valeur: <%=instance.getPort()%>)</small>
        </td>
    </table>
...
<form action="${pageContext.request.contextPath}/instance/add" method="post">
    ...
    <% for(Server server: instance.getServerList()) {%>
        <tr>
            ...
            <td>
                ...
                <a href="${pageContext.request.contextPath}/instances/delete?name=<%=instance.getName()%>&serverName=<%=server.getName()%>"><button>Supprimer</button></a>
            </td>
        </tr>
    <% } %>
    </tbody>
